...
def proto_model(n):
	...
	n.score    = L.InnerProduct(n.relu33, num_output=cl, param=base_param)
...
with open(osp.join('./', 'net_train_multi.prototxt'), 'w') as f:
	f.write(proto_train())
with open(osp.join('./', 'net_val_multi.prototxt'), 'w') as f:
	f.write(proto_val())
